use crate::game::world::chunk::{ChunkBlockCoordinate, ChunkCoordinate, CHUNK_HEIGHT, CHUNK_SIZE};
...
impl Block {
    pub fn get_block_properties(self) -> BlockProperties {
        match self {
            Block::Air => BlockProperties { is_solid: false },
            Block::Grass => BlockProperties { is_solid: true },
        }
    }
}
